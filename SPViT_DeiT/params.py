...
parser.add_argument('--sparse_block_mode', default=0, type=int, help='sparse policy')
parser.add_argument('--custom_blocks', default='', type=str, help='custom sparse blocks')
parser.add_argument('--transformer_type', default='normal', type=str, help='')
